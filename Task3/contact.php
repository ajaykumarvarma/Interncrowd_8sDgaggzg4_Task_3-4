...
<div class="row">
<div class="col-md-8">
<h1><img src="https://www.pngfind.com/pngs/m/9-98971_contact-us-icon-in-black-ndash-free-icons.png" width="80px">    Contact Ajay Kumar Varma</h1>
<div class="ctform">
    <form name="contact-form" action="" method="post" id="contact-form" class="ctform">
